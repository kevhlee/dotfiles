...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap("n", "<leader>dj", vim.diagnostic.goto_next)
  buf_set_keymap("n", "<leader>do", vim.diagnostic.open_float)
  buf_set_keymap("n", "<leader>dk", vim.diagnostic.goto_prev)
